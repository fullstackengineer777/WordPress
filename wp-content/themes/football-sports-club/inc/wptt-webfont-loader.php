...
if ( ! class_exists( 'Football_Sports_Club_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Football_Sports_Club_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Football_Sports_Club_WPTT_WebFont_Loader( $url );
