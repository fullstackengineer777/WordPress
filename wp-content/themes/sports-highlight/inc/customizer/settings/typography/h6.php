<?php
/**
 * Controls and settings of H6 in Typography Panel.
 *
...
$section_id = 'typography_h6_section';
$panel_id   = 'typography_panel';

$wp_customize->add_section(
	$section_id,
	array(
		'title'      => esc_html__( 'H6', 'sports-highlight' ),
		'priority'   => 160,
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h6_toggle',
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h6_font_header',
		'sanitize_callback' => 'sanitize_text_field',
		'label'             => esc_html__( 'Font', 'sports-highlight' ),
		'section'           => $section_id,
		'active_callback'   => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_is_typography_h6' ),
	)
);
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h6_font_dropdown',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_h6_font_variant_dropdown',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
