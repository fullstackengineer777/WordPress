<?php
/**
 * Controls and settings of Navigation in Typography Panel.
 *
...
$section_id = 'typography_navigation_section';
$panel_id   = 'typography_panel';

$wp_customize->add_section(
	$section_id,
	array(
		'title'      => esc_html__( 'Menu', 'sports-highlight' ),
		'priority'   => 120,
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_navigation_toggle',
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_navigation_font_header',
		'sanitize_callback' => 'sanitize_text_field',
		'label'             => esc_html__( 'Font', 'sports-highlight' ),
		'section'           => $section_id,
		'active_callback'   => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_is_typography_navigation' ),
	)
);
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_navigation_font_dropdown',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_navigation_font_variant_dropdown',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_navigation_text_transform',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_navigation_font_size',
		'sanitize_callback' => 'absint',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-range-value',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Range_Value_Control',
		'name'              => 'typography_option_navigation_line_height',
		'sanitize_callback' => 'absint',
