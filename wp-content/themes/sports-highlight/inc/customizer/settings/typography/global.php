<?php
/**
 * Controls and settings of H1 in Typography Panel.
 *
...
$section_id = 'typography_global_section';
$panel_id   = 'typography_panel';

$wp_customize->add_section(
	$section_id,
	array(
		'title'      => esc_html__( 'Global Typography', 'sports-highlight' ),
		'priority'   => 100,
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_global_toggle',
		'sanitize_callback' => 'absint',
		'label'             => esc_html__( 'Font Settings', 'sports-highlight' ),
		'description'       => esc_html__( 'The settings below will apply to all headlines if not configured separately.', 'sports-highlight' ),
		'section'           => $section_id,
	)
);
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_global_font',
		'sanitize_callback' => 'sanitize_text_field',
		'label'             => esc_html__( 'Font', 'sports-highlight' ),
		'section'           => $section_id,
		'active_callback'   => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_is_typography_global' ),
	)
);
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_global_font_dropdown',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_global_font_variant',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_global_text_transform',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_global_font_size',
		'sanitize_callback' => 'absint',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-range-value',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Range_Value_Control',
		'name'              => 'typography_option_global_line_height',
		'sanitize_callback' => 'absint',
