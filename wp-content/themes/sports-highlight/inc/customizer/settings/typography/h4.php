<?php
/**
 * Controls and settings of H4 in Typography Panel.
 *
...
$section_id = 'typography_h4_section';
$panel_id   = 'typography_panel';

$wp_customize->add_section(
	$section_id,
	array(
		'title'      => esc_html__( 'H4', 'sports-highlight' ),
		'priority'   => 140,
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h4_toggle',
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h4_font_header',
		'sanitize_callback' => 'sanitize_text_field',
		'label'             => esc_html__( 'Font', 'sports-highlight' ),
		'section'           => $section_id,
		'active_callback'   => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_is_typography_h4' ),
	)
);
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h4_font_dropdown',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_h4_font_variant_dropdown',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-dropdown-control',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Dropdown_Control',
		'name'              => 'typography_option_h4_text_transform',
		'sanitize_callback' => array( 'Sports_Highlight\Customizer_Callbacks', 'customizer_sanitize_select' ),
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'typography_option_h4_font_size',
		'sanitize_callback' => 'absint',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'sports-highlight-range-value',
		'custom_control'    => 'Sports_Highlight\Custom_Control\Customizer_Range_Value_Control',
		'name'              => 'typography_option_h4_line_height',
		'sanitize_callback' => 'absint',
