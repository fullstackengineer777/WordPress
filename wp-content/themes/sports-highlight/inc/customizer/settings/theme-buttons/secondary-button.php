<?php
/**
 * Controls and settings of Secondary Button in Theme Buttons Panel.
 *
...
$section_id = 'theme_buttons_secondary_button_section';
$panel_id   = 'theme_buttons_panel';

$wp_customize->add_section(
	$section_id,
	array(
		'title'      => esc_html__( 'Secondary Buttons', 'sports-highlight' ),
		'priority'   => 120,
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'color',
		'name'              => 'theme_buttons_secondary_buttons_bg_color',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'color',
		'name'              => 'theme_buttons_secondary_buttons_hover',
		'sanitize_callback' => 'Sports_Highlight\Customizer_Callbacks::sanitize_hex_color',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'color',
		'name'              => 'theme_buttons_secondary_buttons_font',
		'sanitize_callback' => 'Sports_Highlight\Customizer_Callbacks::sanitize_hex_color',
...
Customizer_Helpers::register_option(
	...
	array(
		'type'              => 'color',
		'name'              => 'theme_buttons_secondary_buttons_font_hover',
		'sanitize_callback' => 'Sports_Highlight\Customizer_Callbacks::sanitize_hex_color',
...
Customizer_Helpers::register_option(
	...
	array(
		...
		'name'              => 'theme_buttons_secondary_buttons_secondary_border_radius',
