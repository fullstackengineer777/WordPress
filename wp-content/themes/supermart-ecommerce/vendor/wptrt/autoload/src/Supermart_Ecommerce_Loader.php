...
class Supermart_Ecommerce_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function supermart_ecommerce_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function supermart_ecommerce_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function supermart_ecommerce_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function supermart_ecommerce_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->supermart_ecommerce_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function supermart_ecommerce_load( $class ) {
